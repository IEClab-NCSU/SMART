...
def prep_evaluation_folders():
    output_path = 'gpt_output_public_test/'
    results_path = 'gpt_evaluation_public_test/'
...
def main():
    ...
    for course in ['bio', 'chem']:
        ...
        test_dataset_path = f'ValidationDatasets/test_{course}_full.txt'
        ...
        best_model_path = f'FineTunedModels/inspec_kdd_first_only_80_percent_epochs_$epoch{best_num_epochs}'
        ...
        test_output_df['processed_keyphrases'] = test_df['processed_keyphrases']
        test_output_df['generated_keyphrases'] = test_generated_keyphrases

        filename = f'test_{course}_epochs_{best_num_epochs}_output.csv'
        gpt_output_path = 'gpt_output_public_test/' + filename
    ...
    gpt_evaluation_path = 'gpt_evaluation_public_test/GPT2-finetuned-models-evaluation-num-epochs-public.csv'
