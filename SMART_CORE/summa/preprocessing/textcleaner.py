...
# modified 5/19/2021: previous version assumed all tokens were verbs
...
def filter_words(sentences):
    # filters = [lambda x: x.lower(), strip_numeric, strip_punctuation, remove_stopwords, stemp_sentence]
    filters = [lambda x: x.lower(), strip_numeric, strip_punctuation, remove_stopwords, lemmatize_sentence]
